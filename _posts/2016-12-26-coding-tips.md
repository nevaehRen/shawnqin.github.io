...
* Advanced programming techniques can be found [here](https://math.la.asu.edu/files/support/docs/matlab_workshop/Adv_Programming.pdf) and [here](http://www2.engr.arizona.edu/~sail/matlab_optimization.pdf). Tips on writing MATLAB [function](http://uk.mathworks.com/matlabcentral/mlc-downloads/downloads/submissions/21653/versions/3/previews/tutorial/writingFunctions.html). A tutorial of [debuging and optimization](http://www2.engr.arizona.edu/~sail/matlab_optimization.pdf).
